...
function printAutoForm(){
  ...
  var a='<div class="divMiddle"><table id="dataTableTop"></table><table onkeyup="getTotalCapacity()" id="dataTable"></table>Суммарная мощность <input type="text" readonly="" id="totalCapacity" value="0"/> Вт</div><table id="addParamTable"><tr><td>',
      ...
      d='<div id="divBot"><a href="#" class="a_demo_one" onclick="showEmailDiv()">Отправить расчёты на почту</a></div><table id="calcTable"></table>';
